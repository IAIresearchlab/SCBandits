...
simSetDescriptive="../simulation_saves/TSPPDIsEffectFast" #Give descriptive name for directory to save set of sims
simSetDescriptive="../simulation_saves/TSPPDIsEffectFastFullHistory" #Give descriptive name for directory to save set of sims
mkdir -p $simSetDescriptive

effectSizesB=(0.1 0.2 0.3 0.5);
effectSizesB=(0.1 0.08 0.3 0.5);

...
simSetDescriptive="../simulation_saves/TSPPDNoEffectFastJeffPrior" #Give descriptive name for directory to save set of sims
simSetDescriptive="../simulation_saves/TSPPDNoEffectFastJeffPriorRWCutoffs" #Give descriptive name for directory to save set of sims

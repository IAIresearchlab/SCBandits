...
H_ALGO_EXPLORING = "IsExploring" # 1 when exploring with epsilon greedy, ie. epsilon of the time
H_ALGO_MEAN_1 = "Action1MeanReward"
H_ALGO_MEAN_2 = "Action2MeanReward"
IPWS_COL = "ipws"

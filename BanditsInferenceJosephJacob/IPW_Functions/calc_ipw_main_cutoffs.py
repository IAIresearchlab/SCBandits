...
def calculate_ipw_save(actions_infile, num_samples, num_actions = 2, cached_probs={}, 
...
def calculate_ipw_by_step_size(actions_root, num_samples, num_actions = 2, cached_probs={}, 
    ...
    for num_steps in step_sizes:
        ...
        for sim_count in range(num_sims):
           ...
           # print(actions_df)
            ...
            calculate_ipw_save(actions_infile, num_samples, num_actions = 2, cached_probs={}, 
              prior = [1,1], binary_rewards = True, config = {})
...
#Effect-----------------
#Extra Problems-----------
root = '../Outfile/ParamsBased/EffectnumSims{}problem_print_outputRedo/' #Not used
root_cutoffs = '../Outfile/ParamsBased/numSims{}ForCutoffsCenters/'

experiment_title = "Extra Problem"#Not used
condition_header = "problem_print_output"#Not used
...
#num_sims=5000
#Extra Problems-----------  For cutoffs only need outcomes, not factors, so okay to just use mot mess

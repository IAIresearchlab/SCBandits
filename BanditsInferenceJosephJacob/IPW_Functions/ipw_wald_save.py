...
def calculate_ipw_hyp_test(actions_infile, num_samples, num_actions = 2, cached_probs={}, 
...
#    print("count of max_weights:", max_weights, "/", len(cache_keys) - 1)
    ...
    return wald_pval_ipw, wald_type_stat_ipw



def calculate_ipw_hyp_test_by_step_size(actions_root, num_samples, num_actions = 2, cached_probs={}, 
    ...
    for num_steps in step_sizes:
        ...
        for sim_count in range(num_sims):
           ...
           # print(actions_df)
            ...
            wald_pval_ipw, wald_type_stat_ipw = calculate_ipw_hyp_test(actions_infile, num_samples, num_actions = 2, cached_probs={}, 
              prior = [1,1], binary_rewards = True, config = {})
...
#        ipw_t1_list.append(ipw_t1)
        ...
        print("saving to:", actions_root + "-ipw_wald_stat_per_sim_{}.npy".format(num_steps))
        
        np.save(actions_root + "-ipw_wald_stat_per_sim_{}.npy".format(num_steps), wald_type_stat_ipw_simlist)
    #print("g")
   ...
   # fig.set_size_inches(17.5, 13.5)
    ...
    for outcome in outcomes_list:
            ...
            for bs_prop in bs_prop_list:
                ...
                calculate_ipw_hyp_test_by_step_size(actions_root = actions_root, num_samples=1000, num_actions = 2, cached_probs = {}, \
